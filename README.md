...
- Para atualizar sua senha, o usuário deve comfirar sua nova senha;
...
- As notificações do prestador devem ser enviado em tempo-real utilizando Socket.io;
...
- O usuário deve poder listar horários disponíveis de um dia específica de um prestador;
